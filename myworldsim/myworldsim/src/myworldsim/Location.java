...
public class Location
{
	...
	public int getExit(String direction) {
		...
		if(direction.equalsIgnoreCase(Direction.NORTH.toString()) || direction.equalsIgnoreCase("S")) {
			exitNumber = 1;
		}
		...
		else if (direction.equalsIgnoreCase(Direction.WEST.toString()) || direction.equalsIgnoreCase("W")) {
			exitNumber = 3;
		}
		else if (direction.equalsIgnoreCase(Direction.NORTHEAST.toString()) || direction.equalsIgnoreCase("NE")) {
			exitNumber = 4;
		}
		...
		else if (direction.equalsIgnoreCase(Direction.SOUTHWEST.toString()) || direction.equalsIgnoreCase("SW")) {
			exitNumber = 7;
		}
		else if (direction.equalsIgnoreCase(Direction.UP.toString()) || direction.equalsIgnoreCase("U")) {
			exitNumber = 8;
		}
		else if (direction.equalsIgnoreCase(Direction.DOWN.toString()) || direction.equalsIgnoreCase("D")) {
			exitNumber = 9;
		}
		return exitNumber;
