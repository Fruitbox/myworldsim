...
public class AssaultRiffle extends Gun
{
	...
	public AssaultRiffle( int type,int damage, double weight, int accuracy, int range, int mobility, boolean automatic, int ammo, int caliber, int recoil, boolean scope, int RPM)
