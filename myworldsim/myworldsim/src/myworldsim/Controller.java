...
public class Controller {
	...
	public Controller() {
		...
		System.out.println("Controller::Controller(): Unable to create the Binary Search Command Tree. Command list is empty");
	}
}

		else {
			System.out.println("Controller::Controller(): Unable to create the Binary Search Command Tree. Check sql server");
	...
	public void setCurrentLocation(Object newLocation) {
		// TODO Auto-generated method stub
